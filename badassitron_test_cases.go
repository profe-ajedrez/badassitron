	...
	return []struct {
	...
	}{
		{
			...
			want: Detail{
				...
				Taxes:          []TaxDetail{{"1", ivaMx, alpacadecimal.NewFromInt(144), alpacadecimal.NewFromInt(900), 0, 1, true}},
	...
	return []struct {
	...
	}{
		{
			...
			&Detail{
				...
				Taxes: []TaxDetail{
					{"1", func() alpacadecimal.Decimal { d, _ := alpacadecimal.NewFromString("18"); return d }(), alpacadecimal.Zero, alpacadecimal.Zero, Unit, SecondStage, Percentual},
					{"1", func() alpacadecimal.Decimal { d, _ := alpacadecimal.NewFromString("0"); return d }(), func() alpacadecimal.Decimal { d, _ := alpacadecimal.NewFromString("1"); return d }(), alpacadecimal.Zero, Unit, FirstStage, Amount},
					{"1", func() alpacadecimal.Decimal { d, _ := alpacadecimal.NewFromString("0"); return d }(), func() alpacadecimal.Decimal { d, _ := alpacadecimal.NewFromString("0.5"); return d }(), alpacadecimal.Zero, Line, ThirdStage, Amount},
				},
			},
		...
		},
		{
			...
			&Detail{
				...
				Taxes: []TaxDetail{
					{"1", func() alpacadecimal.Decimal { d, _ := alpacadecimal.NewFromString("-18"); return d }(), alpacadecimal.Zero, alpacadecimal.Zero, Unit, 2, true},
					{"1", func() alpacadecimal.Decimal { d, _ := alpacadecimal.NewFromString("0"); return d }(), func() alpacadecimal.Decimal { d, _ := alpacadecimal.NewFromString("1"); return d }(), alpacadecimal.Zero, Unit, 1, false},
					{"1", func() alpacadecimal.Decimal { d, _ := alpacadecimal.NewFromString("0"); return d }(), func() alpacadecimal.Decimal { d, _ := alpacadecimal.NewFromString("0.5"); return d }(), alpacadecimal.Zero, Line, 3, false},
				},
			},
			func() alpacadecimal.Decimal { d, _ := alpacadecimal.NewFromString("870"); return d }(),
			func() alpacadecimal.Decimal { d, _ := alpacadecimal.NewFromString("1000"); return d }(),
